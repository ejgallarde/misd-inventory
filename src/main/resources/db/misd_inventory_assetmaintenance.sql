...
-- destroyed `assetmaintenance` and everything cascading from it, with no prompt.
...
CREATE TABLE `assetmaintenance` (
  ...
  CONSTRAINT `assetmaintenance_ibfk_1` FOREIGN KEY (`AssetTag`) REFERENCES `assets` (`AssetTag`) ON DELETE CASCADE
