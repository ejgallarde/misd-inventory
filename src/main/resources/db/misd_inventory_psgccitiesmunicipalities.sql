...
--
-- Table structure for table `psgccitiesmunicipalities`
--
...
-- destroyed `psgccitiesmunicipalities` and everything cascading from it, with no prompt.
-- To recreate the table from scratch, drop it deliberately first.
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `psgccitiesmunicipalities` (
  ...
  KEY `IX_PsgcCities_ProvinceCode` (`ProvinceCode`),
  CONSTRAINT `FK_PsgcCities_Province` FOREIGN KEY (`ProvinceCode`) REFERENCES `psgcprovinces` (`ProvinceCode`)
