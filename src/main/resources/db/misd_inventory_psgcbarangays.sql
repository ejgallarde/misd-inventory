...
--
-- Table structure for table `psgcbarangays`
--
...
-- destroyed `psgcbarangays` and everything cascading from it, with no prompt.
-- To recreate the table from scratch, drop it deliberately first.
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `psgcbarangays` (
  ...
  KEY `IX_PsgcBarangays_CityCode` (`CityMunicipalityCode`),
  CONSTRAINT `FK_PsgcBarangays_City` FOREIGN KEY (`CityMunicipalityCode`) REFERENCES `psgccitiesmunicipalities` (`CityMunicipalityCode`)
